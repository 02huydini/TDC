...
public class CostDisplay : MonoBehaviour
{
    ...
    // Exposes the wired tower prefab so other scripts (TowerHotkeys.cs) can find
    // out what this shop slot actually builds, without needing a second,
    // possibly-out-of-sync list of tower prefabs of their own.
